...
// Hand-vendored from the shadcn/ui new-york `table` block, matching how the
// other primitives in this directory were vendored: no dependency, no
// components.json, just the semantic elements and their class conventions.
// Unlike the Radix-backed primitives here, these have no underlying primitive
// to take an ElementRef from, so the ref element type is spelled out (the same
// way `input.tsx` and `card.tsx` do it).
//
