 ...
 */
export type SessionPresentation = "awaiting_candidate" | "live" | "completed" | "failed";

/** The only fields a Session's presented label may be derived from. */
export type StateBearingSession = Pick<Session, "status" | "end_reason">;

/**
 * The product's vocabulary for each presented label, in one place because
